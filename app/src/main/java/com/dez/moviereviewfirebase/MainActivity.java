package com.dez.moviereviewfirebase;
...
public class MainActivity extends AppCompatActivity {
    ...
    EditText getmMovieReviewTextET;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DatabaseReference dbReference = database.getReference(); //Reference to the root key of your data base
...
//    ValueEventListener
    ...
    private void fetchAllReviews() {
        ...
        reviewsReference.orderByChild("name").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
